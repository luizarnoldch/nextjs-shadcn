...
${innerJSX}
  ...
  const highlightedCode = generateCode()
    ...
    .replace(
      /&lt;(\/?)Empty([A-Za-z]*)(.*?)&gt;/g,
      `&lt;$1<span class="${hlTag}">Empty$2</span>$3&gt;`,
    )
    .replace(
      /&lt;(\/?)Button(.*?)&gt;/g,
    ...
    .replace(
      /&lt;(\/?)FolderOpen(.*?)&gt;/g,
      `&lt;$1<span class="${hlTag}">FolderOpen</span>$2&gt;`,
    )
    .replace(
      /&lt;(\/?)Upload(.*?)&gt;/g,
      `&lt;$1<span class="${hlTag}">Upload</span>$2&gt;`,
    )
    .replace(
      /&lt;(\/?)div(.*?)&gt;/g,
    ...
    <div className="flex flex-col gap-6 p-4">
      <div className="grid gap-1">
        ...
        <p className="text-muted-foreground">
          A stylized layout designed to present empty states for datatables,
          file systems, and collections.
        </p>
      </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col">
                ...
                <span className="text-xs text-muted-foreground">
                  Changes the icon wrapper style
                </span>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col">
                ...
                <span className="text-xs text-muted-foreground">
                  Renders a primary call-to-action
                </span>
              </div>
              <Button
          ...
          <div className="relative z-10 w-full flex justify-center">
            <Empty className="w-full max-w-md mx-auto bg-card shadow-sm">
              <EmptyHeader>
                ...
                <EmptyDescription>
                  You haven't uploaded any files yet. Upload a file to get
                  started.
                </EmptyDescription>
              </EmptyHeader>
              {(showContent || showAction) && (
                <EmptyContent>
                  {showContent && (
                    <div className="flex flex-col items-center text-muted-foreground">
                      <p>
                        Tip: You can drag and drop your files directly here.
                      </p>
                    </div>
                  )}
                  {showAction && (
