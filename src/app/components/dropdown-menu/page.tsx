...
export default function DropdownMenuDemoPage() {
  ...
  const generateCode = () => {
    ...
    parts.push(`            Profile`);
    if (showShortcuts) parts.push(`            <DropdownMenuShortcut>⇧⌘P</DropdownMenuShortcut>`);
    parts.push(`          </DropdownMenuItem>`);
    parts.push(`          <DropdownMenuItem>`);
    parts.push(`            Billing`);
    if (showShortcuts) parts.push(`            <DropdownMenuShortcut>⌘B</DropdownMenuShortcut>`);
    parts.push(`          </DropdownMenuItem>`);
    parts.push(`          <DropdownMenuItem>`);
    parts.push(`            Settings`);
    if (showShortcuts) parts.push(`            <DropdownMenuShortcut>⌘S</DropdownMenuShortcut>`);
    parts.push(`          </DropdownMenuItem>`);
    parts.push(`          <DropdownMenuItem>`);
    parts.push(`            Keyboard shortcuts`);
    if (showShortcuts) parts.push(`            <DropdownMenuShortcut>⌘K</DropdownMenuShortcut>`);
    parts.push(`          </DropdownMenuItem>`);
    parts.push(`        </DropdownMenuGroup>`);
    parts.push(`        <DropdownMenuSeparator />`);
    parts.push(`        <DropdownMenuGroup>`);
    ...
    parts.push(`            <DropdownMenuSubTrigger>Invite users</DropdownMenuSubTrigger>`);
    ...
    parts.push(`          <DropdownMenuItem>`);
    parts.push(`            New Team`);
    if (showShortcuts) parts.push(`            <DropdownMenuShortcut>⌘+T</DropdownMenuShortcut>`);
    parts.push(`          </DropdownMenuItem>`);
    parts.push(`        </DropdownMenuGroup>`);

    if (showCheckboxItems) {
      parts.push(`        <DropdownMenuSeparator />`);
      parts.push(`        <DropdownMenuCheckboxItem checked={showStatusBar} onCheckedChange={setShowStatusBar}>`);
      parts.push(`          Status Bar`);
      parts.push(`        </DropdownMenuCheckboxItem>`);
      parts.push(`        <DropdownMenuCheckboxItem checked={showActivityBar} onCheckedChange={setShowActivityBar} disabled>`);
      parts.push(`          Activity Bar`);
      parts.push(`        </DropdownMenuCheckboxItem>`);
      parts.push(`        <DropdownMenuCheckboxItem checked={showPanel} onCheckedChange={setShowPanel}>`);
      parts.push(`          Panel`);
      parts.push(`        </DropdownMenuCheckboxItem>`);
    }
    ...
    if (showRadioItems) {
      parts.push(`        <DropdownMenuSeparator />`);
      parts.push(`        <DropdownMenuLabel>Panel Position</DropdownMenuLabel>`);
      parts.push(`        <DropdownMenuSeparator />`);
      parts.push(`        <DropdownMenuRadioGroup value={position} onValueChange={setPosition}>`);
      parts.push(`          <DropdownMenuRadioItem value="top">Top</DropdownMenuRadioItem>`);
      parts.push(`          <DropdownMenuRadioItem value="bottom">Bottom</DropdownMenuRadioItem>`);
      parts.push(`          <DropdownMenuRadioItem value="right">Right</DropdownMenuRadioItem>`);
    ...
    parts.push(`        <DropdownMenuItem>`);
    parts.push(`          Log out`);
    if (showShortcuts) parts.push(`          <DropdownMenuShortcut>⇧⌘Q</DropdownMenuShortcut>`);
    parts.push(`        </DropdownMenuItem>`);
    ...
    if (showCheckboxItems) {
      stateDeclarations.push(`  const [showStatusBar, setShowStatusBar] = React.useState(true)`);
      stateDeclarations.push(`  const [showActivityBar, setShowActivityBar] = React.useState(false)`);
      stateDeclarations.push(`  const [showPanel, setShowPanel] = React.useState(false)`);
    }
    if (showRadioItems) {
      stateDeclarations.push(`  const [position, setPosition] = React.useState("bottom")`);
    }
...
${innerJSX}
  ...
  const highlightedCode = generateCode()
    ...
    // Tags
    .replace(/&lt;(\/?)DropdownMenu([A-Za-z]*)(.*?)&gt;/g, `&lt;$1<span class="${hlTag}">DropdownMenu$2</span>$3&gt;`)
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56">
                ...
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuItem>
                    Keyboard shortcuts
                    {showShortcuts && <DropdownMenuShortcut>⌘K</DropdownMenuShortcut>}
                  </DropdownMenuItem>
                </DropdownMenuGroup>
                <DropdownMenuSeparator />
                <DropdownMenuGroup>
