...
export default function AlertDialogPage() {
  ...
  const [cancelVariant, setCancelVariant] = useState<
    "default" | "destructive" | "outline" | "secondary" | "ghost" | "link"
  >("outline");
  const [cancelSize, setCancelSize] = useState<
    "default" | "sm" | "lg" | "icon"
  >("default");
    ...
    <div className="flex flex-col gap-6 p-4">
      <div className="grid gap-1">
        ...
        <p className="text-muted-foreground">
          Interactive showcase of the Alert Dialog component with strict native
          props and text sizing options.
        </p>
      </div>
        ...
        <div className="flex flex-col gap-6 w-full lg:w-[450px] p-6 border rounded-lg bg-card max-h-[85vh] overflow-y-auto">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-wrap">
                {(["default", "sm", "lg", "icon"] as const).map((s) => (
                  <Button
                    key={s}
                    variant={triggerSize === s ? "default" : "outline"}
                    size="sm"
                    onClick={() => setTriggerSize(s)}
                  >
                    {s}
                  </Button>
                ))}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-wrap">
                <Button
                  variant={triggerTextSize === "" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setTriggerTextSize("")}
                >
                  Default
                </Button>
                <Button
                  variant={
                    triggerTextSize === "text-xs" ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() => setTriggerTextSize("text-xs")}
                >
                  XS
                </Button>
                <Button
                  variant={
                    triggerTextSize === "text-lg" ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() => setTriggerTextSize("text-lg")}
                >
                  LG
                </Button>
              </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                <Button
                  variant={contentSize === "default" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setContentSize("default")}
                >
                  Default (lg)
                </Button>
                <Button
                  variant={contentSize === "sm" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setContentSize("sm")}
                >
                  Small (sm)
                </Button>
              </div>
            ...
            <div className="flex flex-col gap-2">
              <span className="text-sm font-medium">
                Header Global Text Size
              </span>
              <div className="flex gap-2 flex-wrap">
                <Button
                  variant={headerTextSize === "" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setHeaderTextSize("")}
                >
                  Default
                </Button>
                <Button
                  variant={headerTextSize === "text-xl" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setHeaderTextSize("text-xl")}
                >
                  XL
                </Button>
              </div>
            ...
            {showMedia && (
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2 flex-wrap">
                  <Button
                    variant={mediaIconSize === "size-4" ? "default" : "outline"}
                    size="sm"
                    onClick={() => setMediaIconSize("size-4")}
                  >
                    4
                  </Button>
                  <Button
                    variant={mediaIconSize === "size-8" ? "default" : "outline"}
                    size="sm"
                    onClick={() => setMediaIconSize("size-8")}
                  >
                    8 (Default)
                  </Button>
                  <Button
                    variant={
                      mediaIconSize === "size-12" ? "default" : "outline"
                    }
                    size="sm"
                    onClick={() => setMediaIconSize("size-12")}
                  >
                    12
                  </Button>
                </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-wrap">
                <Button
                  variant={titleTextSize === "" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setTitleTextSize("")}
                >
                  Default
                </Button>
                <Button
                  variant={
                    titleTextSize === "text-base" ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() => setTitleTextSize("text-base")}
                >
                  Base
                </Button>
                <Button
                  variant={titleTextSize === "text-2xl" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setTitleTextSize("text-2xl")}
                >
                  2XL
                </Button>
              </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-wrap">
                <Button
                  variant={descriptionTextSize === "" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setDescriptionTextSize("")}
                >
                  Default
                </Button>
                <Button
                  variant={
                    descriptionTextSize === "text-xs" ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() => setDescriptionTextSize("text-xs")}
                >
                  XS
                </Button>
                <Button
                  variant={
                    descriptionTextSize === "text-base" ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() => setDescriptionTextSize("text-base")}
                >
                  Base
                </Button>
              </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-sm font-medium">
                Footer Wrapper Size/Text
              </span>
              <div className="flex gap-2 flex-wrap">
                <Button
                  variant={footerTextSize === "" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setFooterTextSize("")}
                >
                  Default
                </Button>
                <Button
                  variant={footerTextSize === "text-xs" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setFooterTextSize("text-xs")}
                >
                  XS
                </Button>
                <Button
                  variant={footerTextSize === "text-lg" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setFooterTextSize("text-lg")}
                >
                  LG
                </Button>
              </div>
            ...
            <h4 className="text-sm font-semibold text-red-400 mt-2">
              Action Button
            </h4>
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-wrap">
                {(
                  ...
                  <Button
                    key={v}
                    variant={actionVariant === v ? "default" : "outline"}
                    size="sm"
              ...
              <div className="flex gap-2 flex-wrap">
                {(["default", "sm", "lg", "icon"] as const).map((s) => (
                  <Button
                    key={s}
                    variant={actionSize === s ? "default" : "outline"}
                    size="sm"
                    onClick={() => setActionSize(s)}
                  >
                    {s}
                  </Button>
                ))}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-wrap">
                {(
                  ...
                  <Button
                    key={v}
                    variant={cancelVariant === v ? "default" : "outline"}
                    size="sm"
                    onClick={() => setCancelVariant(v)}
                  >
                    {v}
                  </Button>
                ))}
              ...
              <div className="flex gap-2 flex-wrap">
                {(["default", "sm", "lg", "icon"] as const).map((s) => (
                  <Button
                    key={s}
                    variant={cancelSize === s ? "default" : "outline"}
                    size="sm"
                    onClick={() => setCancelSize(s)}
                  >
                    {s}
                  </Button>
                ))}
              ...
              <AlertDialogHeader className={headerTextSize}>
                {showMedia && (
                  <AlertDialogMedia>
                    <Trash2
                      className={
                        mediaIconSize !== "size-8" ? mediaIconSize : undefined
                      }
                    />
                  </AlertDialogMedia>
                )}
                <AlertDialogTitle className={titleTextSize}>
                  {title}
                </AlertDialogTitle>
          ...
          <code>
            ...
            {showMedia && (
              <>
                <br />
                {"  "}
                <span className={hlContent}>AlertDialogMedia</span>,
              </>
            )}
            <br />
            {"}"} <span className={kw}>from</span>{" "}
            <span className={str}>"@/components/ui/alert-dialog"</span>
            <br />
            <span className={kw}>import</span> {"{"} Button {"}"}{" "}
            <span className={kw}>from</span>{" "}
            <span className={str}>"@/components/ui/button"</span>
            <br />
            {showMedia && (
              <>
                <span className={kw}>import</span> {"{"} Trash2 {"}"}{" "}
                <span className={kw}>from</span>{" "}
                <span className={str}>"lucide-react"</span>
                <br />
              </>
            )}
            <br />
            <span className={kw}>export default function</span>{" "}
            <span className="text-blue-400">MyAlertDialog</span>() {"{"}
            <br />
            {"  "}
            <span className={kw}>return</span> (<br />
            {"    "}
            <span className={tag}>&lt;AlertDialog&gt;</span>
            <br />
            {"      "}
            <span className={tag}>&lt;AlertDialogTrigger</span>{" "}
            <span className={attr}>asChild</span>
            <span className={tag}>&gt;</span>
            <br />
            {"        "}
            <span className={tag}>&lt;Button</span>{" "}
            <span className={attr}>variant</span>=
            <span className={str}>"outline"</span>
            {triggerSize !== "default" ? (
              <>
                {" "}
                <span className={attr}>size</span>=
                <span className={str}>"</span>
                <span className={hlStyle}>{triggerSize}</span>
                <span className={str}>"</span>
              </>
            ) : (
              ""
            ...
            {triggerTextSize ? (
              <>
                ...
                <span className={str}>"</span>
                <span className={hlStyle}>{triggerTextSize}</span>
                <span className={str}>"</span>
              </>
            ) : (
              ""
            ...
            <span className={tag}>&gt;</span>
            <span className={hlContent}>{triggerText}</span>
            <span className={tag}>&lt;/Button&gt;</span>
            <br />
            {"      "}
            <span className={tag}>&lt;/AlertDialogTrigger&gt;</span>
            <br />
            {"      "}
            <span className={tag}>&lt;AlertDialogContent</span>
            {contentSize !== "default" ? (
              <>
                {" "}
                <span className={attr}>size</span>=
                <span className={str}>"</span>
                <span className={hlLogic}>{contentSize}</span>
                <span className={str}>"</span>
              </>
            ) : (
              ""
            ...
            <br />
            {"        "}
            <span className={tag}>&lt;AlertDialogHeader</span>
            {headerTextSize ? (
              <>
                {" "}
                <span className={attr}>className</span>=
                <span className={str}>"</span>
                <span className={hlStyle}>{headerTextSize}</span>
                <span className={str}>"</span>
              </>
            ) : (
              ""
            ...
            {showMedia && (
              <>
                ...
                {"            "}
                <span className={tag}>
                  &lt;<span className={hlContent}>Trash2</span>
                </span>
                {mediaIconSize !== "size-8" ? (
                  <>
                    {" "}
                    <span className={attr}>className</span>=
                    <span className={str}>"</span>
                    <span className={hlStyle}>{mediaIconSize}</span>
                    <span className={str}>"</span>
                  </>
                ) : (
                  ""
            ...
            {"          "}
            <span className={tag}>&lt;AlertDialogTitle</span>
            {titleTextSize ? (
              <>
                {" "}
                <span className={attr}>className</span>=
                <span className={str}>"</span>
                <span className={hlStyle}>{titleTextSize}</span>
                <span className={str}>"</span>
              </>
            ) : (
              ""
            ...
            <br />
            {"          "}
            <span className={tag}>&lt;AlertDialogDescription</span>
            {descriptionTextSize ? (
              <>
                {" "}
                <span className={attr}>className</span>=
                <span className={str}>"</span>
                <span className={hlStyle}>{descriptionTextSize}</span>
                <span className={str}>"</span>
              </>
            ) : (
              ""
            ...
            <br />
            {"        "}
            <span className={tag}>&lt;AlertDialogFooter</span>
            {footerTextSize ? (
              <>
                {" "}
                <span className={attr}>className</span>=
                <span className={str}>"</span>
                <span className={hlStyle}>{footerTextSize}</span>
                <span className={str}>"</span>
              </>
            ) : (
              ""
            ...
            <br />
            {"          "}
            <span className={tag}>&lt;AlertDialogCancel</span>{" "}
            <span className={attr}>variant</span>=<span className={str}>"</span>
            <span className={hlCancel}>{cancelVariant}</span>
            <span className={str}>"</span> <span className={attr}>size</span>=
            <span className={str}>"</span>
            <span className={hlCancel}>{cancelSize}</span>
            <span className={str}>"</span>
            <span className={tag}>&gt;</span>
            <span className={hlContent}>{cancelText}</span>
            <span className={tag}>&lt;/AlertDialogCancel&gt;</span>
            <br />
            {"          "}
            <span className={tag}>&lt;AlertDialogAction</span>{" "}
            <span className={attr}>variant</span>=<span className={str}>"</span>
            <span className={hlAction}>{actionVariant}</span>
            <span className={str}>"</span> <span className={attr}>size</span>=
            <span className={str}>"</span>
            <span className={hlAction}>{actionSize}</span>
            <span className={str}>"</span>
            <span className={tag}>&gt;</span>
            <span className={hlContent}>{actionText}</span>
            <span className={tag}>&lt;/AlertDialogAction&gt;</span>
            <br />
            {"        "}
            <span className={tag}>&lt;/AlertDialogFooter&gt;</span>
